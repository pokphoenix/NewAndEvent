...
class PromotionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backOffice.marketing.promotion.index');
    }
    ...
    {
        return view('backOffice.marketing.promotion.create');
    }
    ...
    {
        return redirect()->action('backOffice.marketing.promotion.index');
    }
    ...
    {
        return view('backOffice.marketing.promotion.show');
    }
    ...
    {
        return view('backOffice.marketing.promotion.print');
    }
    ...
    {
        return view('backOffice.marketing.promotion.update');
    }
