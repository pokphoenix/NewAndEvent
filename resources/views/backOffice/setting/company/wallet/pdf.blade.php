...
@section('head')
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/back-office/<module_name>/<restful_action>.css')}}"/>
@endsection
...
@section('script')
    <script src="{{ asset('js/back-office/<module_name>/<restful_action>.js') }}"></script>
@endsection