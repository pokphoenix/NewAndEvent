...
@section('head')
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/back-office/logistic/product-transfer/show.css')}}"/>
@endsection
...
@section('body')
<div class="x_title">
    <h4 class="title_tf">PRODUCT TRANSFER #1</h4>
    <div class="x_content">
        ...
        <div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12">
				<span class="letter-to">Transfer Name:</span>
				<span>K Lorem ipsum, sale manager</span>
			</div>               
        </div>
        <div class="row">
			<div class="col-sm-6 col-md-6 col-lg-6">
				<span class="letter-to">Warehouse Start:</span>
				<span>Warehouse 1</span>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6">
				<span class="letter-to">Warehouse End:</span>
        ...
        <div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12">
                <h4 class="title_tf">REMARK</h4>
                <p class="letter-content text-uppercase">
				...
				<table class="table ngin-table">
					<thead>
						<tr>
							...
							<th class="col-sm-3 col-md-3">QTY</th>
						</tr>
                    </thead>
                    <tbody>
                        <tr>
...
@section('modal')
				...
				<div id="myModal-1" class="modal fade" role="dialog">
					...
					@endsection
@section('script')
    <script src="{{ asset('js/back-office/logistic/product-transfer/show.js') }}"></script>
@endsection