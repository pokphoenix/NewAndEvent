  ...
  <form action="{{ $action }}" method="POST">
    ...
    <div class="wrapForm">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" rows="3" name="description" id="description">{{ ( isset($category) ) ? $category->description : '' }}</textarea>
        </div>
    </div>
    <div class="line"></div>
...
<script src="{{ asset('js/back-office/setting/item-type/create.js') }}"></script>
@endsection
