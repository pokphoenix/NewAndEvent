				...
				<div class="col-xs-10">
							...
							<div class="row">
								<div class="col-xs-6">
									<table style="margin-bottom: 5px;">
										<tr>
											<th style="width: 63%;">PRE-ORDER Target :</th>
					...
					<div class="panel-state">
						<div class="row head">
							...
							<div class="col-xs-1">
								<div class="title">Total Pre-SO</div>
							</div>
							<div class="col-xs-1">
		...
		<div class="section-table">
			<table class="table ngin-table pre-order-create-table">
				<thead>
					<tr>
						<th colspan="3"></th>
						<th colspan="7" class="qty group">QTY</th>
					</tr>
					<tr>
						...
						<th class="col-xs-1 group">Total</th>
				...
				<tbody>
					...
					<tr>
						<td class="col-xs-2">
							...
							</button><input type="text" class="form-control">
						</td>
						<td class="col-xs-1">
...
@section('script')
	<script src="{{ asset('js/back-office/pre-order/create.js') }}"></script>
@endsection
