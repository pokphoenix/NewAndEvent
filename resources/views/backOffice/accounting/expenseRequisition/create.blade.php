...
@section('head')
    <link rel="stylesheet" type="text/css" href="{{asset('/css/back-office/accounting/expense-requisition/create.css')}}"/>
@endsection
...
<div id="expense-create">
  ...
  <div class="row font-weight-bold" style="margin-top:30px">
    <div class="col-xs-4 text-center">
      COMPANY
    </div> 
    <div class="col-xs-4 text-center">
  ...
  <div class="row total">
    <div class="col-xs-8 col-xs-offset-4">
      ...
      <div class="row d-flex align-items-center">
        ...
        <div class="col-xs-2 text-right color-waring font-size-xs">
            (50.00!)
        </div> 
        <div class="col-xs-1 text-right">
            THB
      ...
      <div class="row d-flex align-items-center">
        ...
        <div class="col-xs-2 text-right color-gray font-size-big">
            117,625.00
        </div> 
        <div class="col-xs-1 text-right">
            THB
