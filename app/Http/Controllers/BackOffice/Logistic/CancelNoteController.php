...
class CancelNoteController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('backOffice.logistic.cancelNote.index');
    }
    ...
    {
        return view('backOffice.logistic.cancelNote.create');
    }
    ...
    {
        return redirect()->action('backOffice.logistic.cancelNote.index');
    }
    ...
    {
        return view('backOffice.logistic.cancelNote.show');
    }
    ...
    {
        return view('backOffice.logistic.cancelNote.print');
    }
    ...
    {
        return view('backOffice.logistic.cancelNote.update');
    }
