...
namespace DurianSoftware\Http\Controllers\BackOffice\Marketing\Promotion\ConditionGroup;
...
class ConditionController extends Controller
{
    ...
    public function index($promotion_id)
    {
        ...
        return view('backOffice.marketing.promotion.conditionGroup.condition.index');
    }
    ...
    {
        return view('backOffice.marketing.promotion.conditionGroup.condition.create');
    }
    ...
    {
        return redirect()->action('backOffice.marketing.promotion.condition-group.condition.index');
    }
    ...
    {
        return view('backOffice.marketing.promotion.conditionGroup.condition.show');
    }
    ...
    {
        return view('backOffice.marketing.promotion.conditionGroup.condition.print');
    }
    ...
    {
        return view('backOffice.marketing.promotion.conditionGroup.condition.update');
    }
