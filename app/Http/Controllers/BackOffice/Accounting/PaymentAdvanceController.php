...
class PaymentAdvanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backOffice.accounting.paymentAV.index');
    }
    ...
    {
        return view('backOffice.accounting.paymentAV.create');
    }
    ...
    {
        return redirect()->action('backOffice.accounting.paymentAV.index');
    }
    ...
    {
        return view('backOffice.accounting.paymentAV.show');
    }
    ...
    {
        return view('backOffice.accounting.paymentAV.print');
    }
    ...
    {
        return view('backOffice.accounting.paymentAV.update');
    }
