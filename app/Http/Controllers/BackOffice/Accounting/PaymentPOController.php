...
class PaymentPOController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backOffice.accounting.paymentPO.index');
    }
    ...
    {
        return view('backOffice.accounting.paymentPO.create');
    }
    ...
    {
        return redirect()->action('backOffice.accounting.paymentPO.index');
    }
    ...
    {
        return view('backOffice.accounting.paymentPO.show');
    }
    ...
    {
        return view('backOffice.accounting.paymentPO.print');
    }
    ...
    {
        return view('backOffice.accounting.paymentPO.update');
    }
