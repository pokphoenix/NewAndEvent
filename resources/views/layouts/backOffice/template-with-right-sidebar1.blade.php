  ...
  <div class="main_container">
    ...
    <div class="right_col" role="main">
      <div class="" style="width: 100%"> 
        <div class="col-md-9 col-sm-8 col-xs-12 col-custom-center content-left" >
        ...
        <div class="col-md-3 col-sm-4 col-xs-12 col-custom-right  content-right">
          <div class="col-md-12 col-sm-12 col-xs-12 padding-left">
            <div class="x_panel content-center-right-top scroll-2 margin-bottom"  >
              @yield('top-right-sidebar')
            </div>
          </div>
          <div class="col-md-12 col-sm-12 col-xs-12 padding-left">
            <div class="x_panel content-center-right-botton scroll-2 margin-bottom"  >
              @yield('bottom-right-sidebar')
            </div>
          </div>
        </div>
      </div>
