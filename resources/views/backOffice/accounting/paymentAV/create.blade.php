...
@section('head')
<link rel="stylesheet" type="text/css" href="{{ asset('/css/back-office/accounting/payment-av/create.css')}}"/>
@endsection
...
<div class="scroll-2">
<div class="payment-av-create">
    <div class="row header-1 d-flex align-items-center">
        <div class="col-xs-9">
            <div class="row">
                <div class="col-xs-6">
                    <div class="">
            ...
            <table class="table payment">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <label class="total">8,888.00</label>
                        </td>
                        <td>
            ...
            <table class="table sup">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            USED 0.00 USD of 1,111.00 USD REMAINING 1,111.00 USD
                        </td>
                    </tr>
                    @endfor
                </tbody>
    ...
    <section>
        <table class="table photo">
                ...
                <tbody>
                    <tr>
                        <td >
                            <textarea id="remark-remark" class="form-control"></textarea>
                        </td>
                        ...
                        <td style="width:28%">
                            <div class="row">
                                <div class="col-xs-7 text-right hd2">
                                    TOTAL PO AMOUNT
                                </div>
                                <div class="col-xs-5">
                                    11,111.10 USD
...
@section('script')
<script src="{{ asset('js/back-office/accounting/payment-av/create.js') }}"></script>
...
<script type="text/javascript">
    $(function () {
        ...
        var height = $(".photo")[0].clientHeight -30
        $('#remark-remark').css( "height", height+"px" );
