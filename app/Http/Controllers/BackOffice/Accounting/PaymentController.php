...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backOffice.accounting.payment.index');
    }
    ...
    {
        return view('backOffice.accounting.payment.create');
    }
    ...
    {
        return redirect()->action('backOffice.accounting.payment.index');
    }
    ...
    {
        return view('backOffice.accounting.payment.show');
    }
    ...
    {
        return view('backOffice.accounting.payment.print');
    }
    ...
    {
        return view('backOffice.accounting.payment.update');
    }
