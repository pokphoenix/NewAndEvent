...
@section('head')
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/back-office/setting/publisher/index.css')}}"/>
@endsection
          ...
          <tr>
            <td class="col-1">
              <div class="col-1-content" >
                ...
                <div class="form-group">
                  <button type="button" class="btn btn-default-background" onclick="window.location='{{ url("back-office/setting/publisher/create") }}'">
            ...
            <td class="col-3">
              ...
              <div class="text-right col-3-content">
                ...
                <form action="{{route('backOffice.setting.publisher.excel')}}" target="_blank" method="POST">
                      {!! csrf_field() !!}
                  <div class="form-group">
                ...
                <form action="{{route('backOffice.setting.publisher.delete-all')}}" method="POST">
                    {!! csrf_field() !!}
                    <div class="form-group">
        ...
        <tbody>
          ...
          <tr class="@if ( $p->trashed() ) tr-trash @endif">
            <td class="blank">
              ...
              <div class="buttons">
                @if( $p->trashed() )
                  <form action="{{route('backOffice.setting.publisher.restore',$p->id)}}" method="POST">
                    {!! csrf_field() !!}    
                      {!! method_field('patch') !!}
                  ...
                  <form method="POST" action="{{ route('backOffice.setting.publisher.destroy', $p->id) }}">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
                  ...
                  <button type="button" class="btn btn-ngin btn-default" onclick="window.location='{{ url("back-office/setting/publisher/". $p->id ."/edit") }}'">
                    <span class="btn-label">
                      <i class="fa fa-pencil-square-o success" aria-hidden="true"></i>
                    </span>Edit
                  </button>
                  <button type="button" class="btn btn-ngin btn-default" onclick="window.location='{{ route('backOffice.setting.publisher.duplicate', $p->id) }}'">
                    <span class="btn-label">
...
@section('script')
<script src="{{ asset('js/back-office/setting/publisher/index.js') }}"></script>
