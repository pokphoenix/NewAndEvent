...
@section('head')
<link rel="stylesheet" type="text/css" href="{{asset('/css/back-office/accounting/expense-requisition/index.css')}}"/>
@endsection
                    ...
                    <td class="col-1" style="min-width: inherit;width: 145px;">
                        <div class="col-1-content" >
                            ...
                            <div class="form-group" style="display: flex;"> 
                                <button type="button" class="btn btn-default-background" onclick="window.location='{{ route("backOffice.accounting.expense-requisition.create") }}'">
											...
											<td style="width:155px;">
												<div class="row">
													<div class="col-xs-12 no-wrap text-center">
														...
														<button type="button" class="btn btn-ngin btn-default">
															<span class="btn-label" style="left : -6px;"><i class="fa fa-times-circle-o danger" aria-hidden="true"></i></span>
															Payment
														</button>
													</div>
												</div>
												<div class="row" style="margin-top:10px">
													...
													<button type="button" class="btn btn-ngin btn-default">
														<span class="btn-label" style="left:-13px"><i class="fa fa-times-circle-o danger" aria-hidden="true"></i></span>
														Delete
													</button>
												</div>
											</div>
