...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backOffice.logistic.inventory.index');
    }
    ...
    {
        return view('backOffice.logistic.inventory.create');
    }
    ...
    {
        return redirect()->action('backOffice.logistic.inventory.index');
    }
    ...
    {
        return view('backOffice.logistic.inventory.show');
    }
    ...
    {
        return view('backOffice.logistic.inventory.print');
    }
    ...
    {
        return view('backOffice.logistic.inventory.update');
    }
